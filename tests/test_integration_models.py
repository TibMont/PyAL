...
def test_continuous_batch_learninig_pso():
    ...
    samples, _, _ = run_continuous_batch_learning(
        model_sphere,
        reg_model,
...
@pytest.mark.parametrize(
    "reg_model, calculate_test_metrics, initialization, expected_result, single_update",
    [
...
def test_continuous_batch_learning_multi_pso(
    reg_model, calculate_test_metrics, initialization, expected_result, single_update
):
    ...
    res = run_continuous_batch_learning_multi(
        [model_sphere],
...
def test_run_batch_learning_multi():
    ...
    samples, _, _ = run_batch_learning_multi(
        [model_sphere],
        aggregation_function=identity,
        regression_models=[reg_model],
        acquisition_function="ideal",
